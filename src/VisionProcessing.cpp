 ...
 *  		Credits to FRC for providing the sample code.
 */
...
private:
	...
	double VIEW_ANGLE = 64; //View angle for camera, set to Axis m1011 (49.4) by default, 64 for m1013, 51.7 for 206, 52 for HD3000 square, 60 for HD3000 640x480
